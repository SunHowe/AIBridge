    ...
    public static class SkillInstaller
    {
        ...
        private static Dictionary<string, string> BuildTemplateTokens(string projectRoot, AssistantIntegrationTarget target)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { "WORKFLOW_SKILL_RULE", AIBridgeEditorText.For(language, "After entering the workflow, `aibridge-development-workflow` chooses the task branch and decides whether to load additional Skills.", "进入工作流后，由 `aibridge-development-workflow` 选择任务分支，并决定是否继续加载其它 Skill。") },
