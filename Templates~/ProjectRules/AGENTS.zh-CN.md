...
## 知识库规则
- 开始任何 AIBridge 功能调整、命令/菜单/Workflow/Skill/Runtime/模板/文档变更前，先查看 AIBridgeRootDirectory 下的 `Doc~/KnowledgeBaseIndex.md`（默认 `Packages/cn.lys.aibridge/Doc~/KnowledgeBaseIndex.md`），必要时联读同根目录下的 `Doc~/README.md` 和对应专题文档。
